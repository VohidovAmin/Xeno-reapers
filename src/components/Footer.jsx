    ...
    return (
        <footer>
            <div className='footer-con'>
                <div className='left-footer flex flex-col gap-1'>
                    <h1>© 2024 XENO REAPERS. ALL RIGHTS RESERVED.</h1>
                    <p>DEVELOPED BY VOHIDOV AMIN</p>
                </div>

                <nav className='links-footer flex gap-8'>
